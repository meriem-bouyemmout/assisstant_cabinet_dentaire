...
class Accueil:
    ...
    ####################################################################################################
        ...
        # self.sms = ctk.CTkLabel(self.frametop,text="Bienvenue souad",font=('tahoma',40),text_color = "white",pady=50)
        # self.sms.pack()
        
        # image_path = "C:\\Users\\pc\\assist_cabinet_dentaire\\images\\Affiche avec dessins de dents Décoration murale orthodontiste Déco cabinet et clinique dentaire Anatomie des dents Cadeau dentiste - Etsy France.jpg"
        # self.image = Image.open(image_path)    
        # self.image.thumbnail((600,600))
        # self.photo_image = ImageTk.PhotoImage(self.image)
        # self.imgDent = Label(self.master, image=self.photo_image)
        # self.imgDent.place(x=650, y=148, width=400, height=557)



        image_path = "C:\\Users\\pc\\assist_cabinet_dentaire\\images\\Dental Health Board Background, Teeth, Healthy, Dashboard Background Image And Wallpaper for Free Download.jpg"
        self.image = Image.open(image_path)
